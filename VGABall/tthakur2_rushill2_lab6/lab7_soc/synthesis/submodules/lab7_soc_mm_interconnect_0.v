...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> acc_s1_agent:cp_data
	...
	wire   [27:0] rst_s1_agent_m0_address;                                                            // rst_s1_agent:m0_address -> rst_s1_translator:uav_address
	...
	wire  [106:0] rst_s1_agent_rf_source_data;                                                        // rst_s1_agent:rf_source_data -> rst_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] rst_s1_agent_rsp_fifo_out_data;                                                     // rst_s1_agent_rsp_fifo:out_data -> rst_s1_agent:rf_sink_data
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> rst_s1_agent:cp_valid
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> rst_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // rst_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> rst_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> rst_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> rst_s1_agent:cp_endofpacket
	...
	wire  [105:0] acc_s1_agent_rp_data;                                                               // acc_s1_agent:rp_data -> router_009:sink_data
	...
	wire          rst_s1_agent_rp_valid;                                                              // rst_s1_agent:rp_valid -> router_010:sink_valid
	wire  [105:0] rst_s1_agent_rp_data;                                                               // rst_s1_agent:rp_data -> router_010:sink_data
	wire          rst_s1_agent_rp_ready;                                                              // router_010:sink_ready -> rst_s1_agent:rp_ready
	wire          rst_s1_agent_rp_startofpacket;                                                      // rst_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          rst_s1_agent_rp_endofpacket;                                                        // rst_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          rst_s1_agent_rdata_fifo_src_valid;                                                  // rst_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] rst_s1_agent_rdata_fifo_src_data;                                                   // rst_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          rst_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_008:in_0_ready -> rst_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> rst_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> rst_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // rst_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> rst_s1_agent:rdata_fifo_sink_error
