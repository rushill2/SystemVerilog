...
# SDRAM CLK
create_generated_clock -source [get_pins { adder2|sdram_pll|sd1|pll7|clk[1] }] \
...
set_multicycle_path -from [get_clocks {clk_dram_ext}] \
                    -to [get_clocks { adder2|sdram_pll|sd1|pll7|clk[0] }] \
						  -setup 2
...
set_false_path -from * -through * -to [get_ports LED*]
